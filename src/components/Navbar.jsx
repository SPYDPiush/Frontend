...
function Navbar({handleOnLoginCLick,handleOnSignUpClick}) {
  
  const handleOnBurgerEvent = () => {

    document.querySelector('#navbarBasicExample').classList.toggle('is-active')
  }
  ...
  return (
    <nav className="navbar has-shadow" role="navigation" aria-label="main navigation">
      <div className="navbar-brand">
        ...
        <a href="/" className="navabar-item">
        <img src={img} alt="company-logo" className="py-2 px-2 is-rounded-large" style={{maxWidth:"70px"}} />
        </a>
        ...
        <div className="navbar-end">
          <div className="navbar-item">
            <div className="buttons">
              <a className="button is-primary" onClick={handleOnSignUpClick}>
                <strong>Sign up</strong>
              </a>
              <a className="button is-light" onClick={handleOnLoginCLick}>Log in</a>
            </div>
          </div>
        </div>
      </div>
